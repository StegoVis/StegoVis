...
class DecodeHandler(tornado.web.RequestHandler):
	...
	def post(self):
		...
		print('CONFIG_QRCODE_WIDTH', CONFIG_QRCODE_WIDTH)
		print('finish extract_qrcode_bit_list', len(extractQrcodeImgBitList))
		...
		print('finish parse_encoding_str', extractStr)
